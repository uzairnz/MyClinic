    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(networkInfo == null){
                    Toast.makeText(ProfileActivity.this, "Please Connect to Internet to use this feature", Toast.LENGTH_SHORT).show();
                }else {
                            ...
                            if(patientUri == null){
                                ...
                                if(networkInfo == null){
                                    if(bmpByte == null){
                                        ...
                                        Toast.makeText(ProfileActivity.this, "Please Connect to Internet to upload image", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                }else {
                                    cv.put(patientEntry.COLUMN_PUSH_ID, pushId);
